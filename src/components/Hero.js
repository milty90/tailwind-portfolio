  ...
  return `
    <section class="h-full mx-auto grid lg:grid-cols-2 gap-10 pt-0 bg-gray-900 max-w-6xl text-white">
      <div class="text-left flex flex-col items-start md:flex-col md:px-25 lg:px-4 justify-center">
        <img src="./me.jpg" alt="profile picture" class="w-20 h-20 rounded-full border-3 border-gray-400 object-cover ml-2 mb-6 md:mb-10 md:w-30 md:h-30 lg:hidden">
        ...
        <p class="text-l text-gray-400 mb-8 md:text-xl md:mb-10">Mein Name ist Milan. Als Softwareentwickler mit dem Schwerpunkt Frontend-Webentwicklung begeistere ich mich dafür, innovative Ideen in digitale Realität umzusetzen und mich stetig in neue Technologien einzuarbeiten.</p>
      ...
      <div class="flex align-center justify-center inset-y-0 right-0 md:relative">
       ...
       <img src="./me.jpg" alt="profile picture" class="bg-amber-950 hidden lg:block w-20 h-20 rounded-full border-3 border-gray-400 object-cover ml-2 mb-6 md:mt-10 md:w-35 md:h-35 lg:absolute lg:inset-0 hover:shadow-lg hover:scale-160 transition-transform duration-300">
      </div>
    </section>
  `;
}
