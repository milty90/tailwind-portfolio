  ...
  return `
    <section class=" relative h-full mx-auto grid lg:grid-cols-2 gap-10 pt-0 max-w-300 bg-gray-900 text-white">
      <div class="text-left flex flex-col items-start md:flex-col md:px-25 lg:pl-10 lg:pr-0">
        ...
        <i class="fa-brands fa-instagram text-3xl text-gray-400 hover:text-gray-100 hover:scale-120 transition-all duration-75 lg:text-4xl"></i>
        </div>
        <a href="#projects" class="bg-blue-600 hover:bg-linear-to-r from-blue-600 via-purple-500 to-pink-500 px-6 py-3 rounded-lg transition">Projecte ansehen  ↓</a>
      </div>
