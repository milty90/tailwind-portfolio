  ...
  return `
    <section class="h-full mx-auto grid lg:grid-cols-2 gap-10 pt-0 max-w-300 bg-gray-900 text-white">
      <div class="text-left flex flex-col items-start md:flex-col md:px-25 lg:pl-10 lg:pr-0">
        ...
        <i class="fa-brands fa-linkedin text-3xl text-gray-400 hover:text-gray-100 hover:scale-120 transition-all duration-75 lg:text-3xl"></i>
        <i class="fa-brands fa-github text-3xl text-gray-400 hover:text-gray-100 hover:scale-120 transition-all duration-75 lg:text-3xl"></i>
        <i class="fa-solid fa-envelope text-3xl text-gray-400 hover:text-gray-100 hover:scale-120 transition-all duration-75 lg:text-3xl"></i>
        </div>
        <a href="#" class="ml-1 text-lg bg-blue-600 hover:bg-linear-to-r hover:scale-110 hover:translate-x-2 duration-200  from-blue-600 via-purple-500 to-pink-500 px-5 py-2.5 rounded-lg transition">Projekte ansehen <i class="fa-solid fa-arrow-down ml-2.5 mb-1.5 text-sm"></i></a>
      </div>
