  ...
  return `
   <section id="projects" class="flex flex-col justify-center items-center m-20 max-w-6xl mx-auto">
    <h2 class="text-4xl font-bold text-white mt-20 mb-5">Meine Projekte</h2>
     <p class="text-gray-400 text-xl mb-20">
          Ein Einblick in meine bisherige Arbeit.
     </p>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:px-5 gap-8 transition-all duration-300 group">
          ...
          <div
            ...
            <div class="flex flex-col flex-1 p-6">
              ...
              <a
                href="https://taschenrechner-m0ix.onrender.com"
                target="_blank"
                class="inline-block text-indigo-500 mb-3 font-medium hover:underline"
                >taschenrechner.onrender.com
                <i class="fa-solid fa-up-right-from-square"></i>
              </a>
              <p class="text-gray-400 mb-4">
                Webanwendung für die Durchführung von mathematischen
                Berechnungen.
              </p>
